...
if istable(LANG.CHAT.RANDOM_SPECTATORS) then
    PHE.LANG.CHAT.RANDOM_SPECTATORS = table.Copy(LANG.CHAT.RANDOM_SPECTATORS)
end

if istable(LANG.DEATHNOTICE.SUICIDE) then
    PHE.LANG.DEATHNOTICE.SUICIDE = table.Copy(LANG.DEATHNOTICE.SUICIDE)
end