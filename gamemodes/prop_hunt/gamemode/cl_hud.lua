...
local bar = {
    hp = {
        h = 5,
        col = Color(250, 40, 10, 240)
    },
    am = {
        h = 5,
        col = Color(80, 190, 255, 220)
    }
}

hook.Add("HUDShouldDraw", "PHE.ShouldHideHUD", function(hudname)
    if GetConVar("ph_hud_use_new"):GetBool() and not matw:IsError() and hide[hudname] then return false end
end)
...
local icons = {
    [TEAM_HUNTERS] = {
        ...
        light = {
            ...
            state = function()
                return LocalPlayer():FlashlightIsOn()
            end
        },
    },
    [TEAM_PROPS] = {
        ...
        spotted = {
            ...
            state = function()
                ...
                if t < 2 then return math.floor((t * 10) % 2) end -- flash for 2 sec
