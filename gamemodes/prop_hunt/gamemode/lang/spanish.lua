...
LANG.DEATHNOTICE.SUICIDE = {"se suicidó", "se mató", "está borracho", "murió por arte de magia", "se tropezó con un palo", "murió misteriosamente",}
...
LANG.CHAT.RANDOM_SPECTATORS = {"para observar las cosas.", "para disfrutar el caos.", "para mirar y relajarse.", "",}
