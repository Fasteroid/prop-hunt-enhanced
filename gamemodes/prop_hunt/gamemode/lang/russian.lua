...
LANG.DEATHNOTICE.SUICIDE = {"суицид!", "умер мистически.", "умер от магии.", "ноу-скоупнул себя.", "просто вышел в ярости.", "пьян.", "умер... удачи в следующий раз!", "шлепнул себя.", "споткнулся об палку.", "умер от силы.", "стал рэгдоллом.",}
...
LANG.CHAT.RANDOM_SPECTATORS = {"ушел наблюдать и отдыхать.", "ушел, чтобы увидеть как вы бегаете.", "ушел, чтобы увидеть вещи.", "",}
