hook.Add("PH_CustomTabMenu", "PHE.About", function(tab, pVgui)
    ...
    pVgui("", "btn", {
        ...
        textdata = {
            [1] = {
                PHE.LANG.PHEMENU.ABOUT.DONATE, function()
                    gui.OpenURL(label.ldonate)
                end
            },
            [2] = {
                PHE.LANG.PHEMENU.ABOUT.HOME, function()
                    gui.OpenURL(label.lhome)
                end
            },
            [3] = {
                PHE.LANG.PHEMENU.ABOUT.GITHUB, function()
                    gui.OpenURL(label.lgit)
                end
            },
        }
    }, grid, "")
