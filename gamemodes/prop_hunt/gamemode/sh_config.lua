...
PHE.IgnoreMutedUserGroup = {"superadmin", "admin"}
...
-- Banned Props models
PHE.BANNED_PROP_MODELS = {"models/props_collectables/piepan.mdl"}
...
if SERVER then
    ...
    local function AddBannedPropModels()
        ...
        local mdlpermabans = {"models/props/cs_assault/dollar.mdl", "models/props/cs_assault/money.mdl", "models/props/cs_office/snowman_arm.mdl", "models/props/cs_office/computer_mouse.mdl", "models/props/cs_office/projector_remote.mdl", "models/foodnhouseholditems/egg.mdl", "models/props/cs_militia/reload_bullet_tray.mdl"}
