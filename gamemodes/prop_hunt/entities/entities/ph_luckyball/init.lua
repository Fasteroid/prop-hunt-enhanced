...
balls.model = {"models/dav0r/hoverball.mdl", "models/maxofs2d/hover_basic.mdl", "models/maxofs2d/hover_classic.mdl", "models/maxofs2d/hover_rings.mdl"}
...
balls.funclists = {
    ...
    -- Change hunter model to player mdl as a joke
    function(pl)
        for _, plph in pairs(player.GetAll()) do
    ...
    -- This is a fun little reference to staging
    function(pl)
