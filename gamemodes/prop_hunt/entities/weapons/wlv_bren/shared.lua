...
-- check if M9K or TFA is Exists on server. otherwise will use from Default base instead.
if CheckConVar(GetConVar("DebugM9K")) or CheckConVar(GetConVar("sv_tfa_conv_m9konvert")) and GetConVar("sv_tfa_conv_m9konvert"):GetBool() then
    SWEP.Gun = "wlv_bren"
    ...
    if GetConVar("ph_mkbren_use_new_mdl"):GetBool() then
        ...
        SWEP.WElements = {
            ["W_MkBren1"] = {
                type = "Model",
                model = "models/weapons/w_mach_brenmk3.mdl",
                bone = "ValveBiped.Bip01_R_Hand",
                rel = "",
                pos = Vector(4.991, 0.171, -1.693),
                angle = Angle(0, -90.326, -6.628),
